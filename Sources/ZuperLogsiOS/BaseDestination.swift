...
open class BaseDestination: Hashable, Equatable {
    ...
    open var minLevel = ZuperLogsiOS.Level.verbose
    ...
    open func send(_ level: ZuperLogsiOS.Level, msg: String, thread: String, file: String,
                   function: String, line: Int, payload: [String: Any]? = nil) -> String? {

        if format.hasPrefix("$J") {
            return messageToJSON(level, msg: msg, thread: thread,
                                 file: file, function: function, line: line, context: payload)
    ...
    func formatMessage(_ format: String, level: ZuperLogsiOS.Level, msg: String, thread: String,
    ...
    func messageToJSON(_ level: ZuperLogsiOS.Level, msg: String,
    ...
    func levelWord(_ level: ZuperLogsiOS.Level) -> String {
    ...
    func colorForLevel(_ level: ZuperLogsiOS.Level) -> String {
        var color = ""
    ...
    func shouldLevelBeLogged(_ level: ZuperLogsiOS.Level, path: String,
