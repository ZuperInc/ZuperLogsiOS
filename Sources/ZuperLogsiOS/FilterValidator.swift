...
struct FilterValidator {
    ...
    private static func filterMatchesCondition(_ filter: FilterType, level: ZuperLogsiOS.Level,
    ...
    private static func filterMatchesMinLogLevel(_ filter: FilterType, level: ZuperLogsiOS.Level) -> Bool {
